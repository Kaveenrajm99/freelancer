            ...
            try {
                ...
                window.localStorage.setItem('loginsecretkey', loginData.data.token);
                {
                    loginData.data.message === "login successfully" ?
                        navigate('/projectlist') : alert("Does not match")
                }
            } catch (error) {
                console.log(error);
        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-sm-12 col-md-12 col-lg-12 login">
                    <div className="mt-2">
                        <h1 className="text-center login-head">Freelancer</h1>
                    </div>
                        ...
                        <form className="m-5" onSubmit={formik.handleSubmit}>
                            <div className="row">
                                <div className="box">
                                    ...
                                    <input type="email" className="form-control boxs" name="email" placeholder="Email" onChange={formik.handleChange} value={formik.values.email} />
                                </div>
                                <div className="box">
